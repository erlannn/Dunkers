<x-app-layout>
    <div class="mb-5 mt-5 flex justify-center">
        <h3 class="text-4xl font-extrabold text-[#E67E22]">Keranjang Belanja</h3>
    </div>

    @if($carts->isEmpty())
        <div class="flex justify-center mt-10 mb-10">
            <div class="text-center">
                <p class="text-xl text-white mb-4">Keranjang Anda kosong</p>
            ...
            <div class="w-full max-w-4xl px-4">
                        ...
                        <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition">
                            <div class="flex items-center gap-4">
                                ...
                                <div class="text-right">
                                    ...
                                    <p class="text-lg font-bold text-[#E67E22]">Rp {{ number_format($subtotal, 0, ',', '.') }}</p>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <p class="text-2xl font-bold text-[#E67E22]">Rp {{ number_format($grandTotal, 0, ',', '.') }}</p>
                    </div>
                    ...
                    <div class="flex justify-between gap-4 ">
                        <a href="{{ route('produk') }}"
                           class="flex-1 px-6 py-3 bg-gray-300 text-gray-800 rounded-lg hover:bg-gray-400 transition font-semibold text-center">
                            Lanjut Belanja
                        </a>
                        ...
                        @else
                            <a href="{{ route('checkout.page') }}"
                               class="flex-1 px-6 py-3 bg-[#E67E22] text-white rounded-lg hover:bg-orange-600 transition font-semibold text-center">
                                Checkout
                            </a>
                        @endif
                    </div>
