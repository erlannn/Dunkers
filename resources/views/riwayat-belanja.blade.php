<x-app-layout>
    <div class="ml-16 mb-5 mt-5 flex justify-center">
        <h3 class="text-4xl font-extrabold text-[#E67E22]">Riwayat Belanja</h3>
    </div>
    ...
    @if($transaksis->isEmpty())
        <div class="flex justify-center mt-10">
            <div class="text-center">
                ...
                <a href="{{ route('produk') }}" class="px-6 py-2 bg-[#E67E22] text-white rounded-lg hover:bg-orange-600">
                    Mulai Belanja
                </a>
            </div>
        </div>
                        ...
                        <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition">
                            <div class="flex justify-between items-start mb-3">
                                ...
                                <div class="text-right">
                                    <p class="text-lg font-bold text-[#E67E22]">
                            ...
                            <div class="flex justify-end gap-2">
                                <a href="{{ route('riwayat-belanja.detail', $transaksi->id) }}" 
                                   class="px-4 py-2 bg-[#E67E22] text-white rounded-lg hover:bg-orange-600 transition text-sm font-semibold">
                                    Lihat Detail
                                </a>
                            </div>
                        </div>
