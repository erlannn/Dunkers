<x-app-layout>
    <div class="ml-16 mb-5 mt-5 flex justify-center">
        <h3 class="text-4xl font-extrabold text-[#E67E22]">Detail Transaksi</h3>
    </div>
        ...
        <div class="w-full max-w-2xl px-4">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <div class="border-t pt-3">
                    <div class="flex justify-between items-center">
                        ...
                        <p class="text-2xl font-bold text-[#E67E22]">Rp {{ number_format($transaksi->total, 0, ',', '.') }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex gap-3 justify-end">
                <a href="{{ route('riwayat-belanja') }}" 
                   class="px-6 py-2 bg-gray-300 text-gray-800 rounded-lg hover:bg-gray-400 transition font-semibold">
                    Kembali
                </a>
            </div>
        </div>
